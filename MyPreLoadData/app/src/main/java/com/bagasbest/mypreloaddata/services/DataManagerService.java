package com.bagasbest.mypreloaddata.services;
...
import com.bagasbest.mypreloaddata.pref.AppPreference;
...
public class DataManagerService extends Service {
    ...
    //buat proses utama untuk mengambil data melalui background process
