package com.bagasbest.mypreloaddata.database;
...
import static com.bagasbest.mypreloaddata.database.DatabaseContract.MahasiswaColumns.NAMA;
import static com.bagasbest.mypreloaddata.database.DatabaseContract.MahasiswaColumns.NIM;
import static com.bagasbest.mypreloaddata.database.DatabaseContract.TABLE_NAME;
...
public class MahasiswaHelper {
    ...
    public long insert (MahasiswaModel mahasiswaModel) {
        ...
        initialValue.put(NAMA, mahasiswaModel.getName());
        initialValue.put(NIM, mahasiswaModel.getNim());
